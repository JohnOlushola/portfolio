...
image: /images/craft-still-wins.webp
---
...
<figure style="width:min(92vw,1024px);margin-left:50%;transform:translateX(-50%);margin-top:2.5em;margin-bottom:2.5em">
  <img src="/images/craft-still-wins.webp" alt="A woman carrying a child walks through farmland under a red umbrella, palm trees and hills behind her" style="width:100%;display:block;border-radius:12px" />
