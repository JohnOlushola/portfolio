...
<figure>
  <video controls autoplay muted loop playsinline src="/videos/craft-still-wins.mp4" style="max-height:60vh;width:auto;max-width:100%;display:block;margin:0 auto;border-radius:12px"></video>
