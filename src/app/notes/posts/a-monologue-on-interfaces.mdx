...
In that case, maybe some solutions do not need to exist anymore. Cue the [SaaSpocalypse](https://sources.news/p/nikesh-arora-theory-of-saaspocalypse). Maybe some solutions stop being hosted and belong to the user. Your rules, your data, running where you are, rather than a seat you rent in someone else's system.
